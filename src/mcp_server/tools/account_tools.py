...
async def get_positions() -> Dict[str, Any]:
    ...
    try:
        ...
        positions_data = []
        portfolio = StateManager.get_portfolio() or TradingPortfolioSchema.from_account_data({})
...
async def get_open_position(symbol: str) -> Dict[str, Any]:
    ...
    try:
        ...
        quantity_text = f"{position.qty} contracts" if is_option else f"{position.qty} shares"
